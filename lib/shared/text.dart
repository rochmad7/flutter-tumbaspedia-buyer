...
const caramemesan =
    '1. Pilih produk UMKM yang akan dipesan lalu pilih jumlah produk yang akan dibeli. Untuk langsung membeli bisa klik "Pesan Sekarang", sedangkan untuk bertanya kepada penjual mengenai produk bisa klik "Hubungi Penjual".\n\n2. Lengkapi data diri pembeli jika masih ada data diri yang kurang seperti alamat dan nomor hp, lalu klik "Proses Sekarang".\n\n3. Jika telah diproses, pesanan Anda akan dicatat dan penjual akan memperoleh email. Anda juga bisa menghubungi penjual saat pesanan selesai dibuat untuk mengingatkan penjual.\n\n4. Sepakati proses pembayaran dengan penjual.\n\n5. Setelah selesai, penjual bisa mengubah status pesanan Anda menjadi "Pesanan Diantar", lalu Anda bisa melakukan konfirmasi penerimaan pesanan';
const statuspesanan =
...
const buatakun =
    '1. Klik "daftar" pada halaman pendaftaran\n\n2. Masukkan data diri yang tertera yaitu Nama Lengkap, Email, No.HP dan Password. Pastikan seluruh data diri benar dan merupakan data yang valid\n\n3. Setelah selesai mengisi data diri, klik "Daftar"\n\n4. Setelah klik "Daftar", maka Anda diharapkan melakukan konfirmasi melalui email yang dikirim ke alamat email terdaftar\n\n3. Setelah melakukan konfirmasi maka akun Tumbaspedia Anda telah aktif dan Anda bisa mengaksesnya serta melakukan pembelian produk yang ada di aplikasi Tumbaspedia.';
